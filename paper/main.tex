...
% ===== DROP-IN ANCHOR: Phase 9 (New-Case Generalization) — do not render yet =====
% \subsection{New-Case Generalization}
% \label{sec:newcase}
% Results on the freshly-ingested .e fracture cases + a fresh from-scratch
% ConvLSTM comparison (NEWC-02..04) land here, under the identical AR-rollout
% protocol used for the 16 in-distribution cases above.
% ===== END DROP-IN ANCHOR: Phase 9 =====
