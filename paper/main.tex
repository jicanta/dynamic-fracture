...
\author{SURF Purdue 2026 --- Dynamic Fracture Project\\
\texttt{(workshop draft)}}
...
crystalline and 2D materials~\citep{hsu2020fracture,lew2021fracture}. These works
target different materials, geometries, and outputs than ours.
...
not merely inherited. We reproduced Kathleen's original ConvLSTM from scratch in
its native TensorFlow/Keras pipeline and evaluated it under the identical AR
protocol. We report this reproduction at an \textbf{honest, verifiable scope of
